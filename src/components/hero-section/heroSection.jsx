            ...
            <div className="swiper-wrapper">
              <div className="hero_slider-slide d-flex flex-column flex-md-row justify-content-between justify-content-md-start align-items-md-center swiper-slide">
                <div className="hero_slider-slide_media">
                  <picture>
                    ...
                    <img className="lazy" src="img/placeholder.jpg" alt="Sepil Product" />
                  </picture>
                </div>
              ...
              <div className="hero_slider-slide d-flex flex-column flex-md-row justify-content-between justify-content-md-start align-items-md-center swiper-slide">
                <div className="hero_slider-slide_media">
                  <picture>
                    <source srcSet="img/placeholder.webp" type="image/webp" />
                    <img className="lazy" src="img/placeholder.jpg" alt="Sepil Plus Product" />
                  </picture>
                </div>
                <div className="hero_slider-slide_main">
              ...
              <div className="hero_slider-slide d-flex flex-column flex-md-row justify-content-between justify-content-md-start align-items-md-center swiper-slide">
                <div className="hero_slider-slide_media">
                  <picture>
                    <source srcSet="img/placeholder.webp" type="image/webp" />
                    <img className="lazy" src="img/placeholder.jpg" alt="Sepilvet Product" />
                  </picture>
                </div>
                <div className="hero_slider-slide_main">
