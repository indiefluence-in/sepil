              ...
              <ul className="footer_main-contacts_list">
                <li className="list-item d-flex align-items-center">
                  ...
                  <div className="wrapper d-flex flex-column">
                    <a className="link" href="tel:+919877668549">+91-98776-68549</a>
                  </div>
                ...
                <li className="list-item d-flex align-items-center">
                  ...
                  <div className="wrapper d-flex flex-column">
                    <span>Shop No. 79, 3rd Floor,</span>
                    <span> Gami Industrial Park C-39A,</span>
                    <span> S Central Road, TTC Industrial Area,</span>
                    <span>  MIDC Industrial Area, Pawne,</span>
              ...
              <ul className="footer_main-instagram_list d-grid">
                <li className="list-item">
                  <a className="link" href="#" target="_blank" rel="noopener norefferer">
                    <picture>
                      <source data-srcset={Plasce} srcSet={Plasce} type="image/webp" />
                      <img
        ...
        <div className="footer_secondary">
          ...
          >
            <p className="footer_secondary-copyright">
              Copyright &copy;  2024,
              <span className="linebreak">All Rights reserved Registered Under Trademark. <span id="currentYear"></span></span>
            </p>
