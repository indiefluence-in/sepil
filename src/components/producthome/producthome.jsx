      ...
      <div className="container d-flex flex-column flex-lg-row">
        ...
        <div className="product_main col-lg-6">
          <a className="product_main-title" href="product.html" target="_blank" rel="noopener norefferer">
            Sepil: Advanced Wound Healing Agent
          </a>
          ...
          <p className="product_main-text">
            Sepil treats diabetic wounds, ulcers, burns, and various types of wounds. Its oil formulation combats Gram-positive and Gram-negative infections, including MRSA, Acinetobacter, and Pseudomonas. Effective for venous and arterio-venous ulcers.
          </p>
          <ul className="product_main-list">
            <li className="list-item d-flex align-items-center">
              <i className="icon-check icon d-flex align-items-center justify-content-center"></i>
              Effective Against MRSA and MDR Gram-Negative Pathogens
            </li>
            <li className="list-item d-flex align-items-center">
              <i className="icon-check icon d-flex align-items-center justify-content-center"></i>
              Oil Formulation for Enhanced Healing
            </li>
            <li className="list-item d-flex align-items-center">
              <i className="icon-check icon d-flex align-items-center justify-content-center"></i>
    ...
    <section className="info section">
      <div className="info_deco">
        <div className="info_deco-wrapper">
          <picture>
            <source srcSet="img/placeholder.jpg" type="image/webp" />
            <img className="lazy leaf leaf--left" src="img/placeholder.jpg" alt="deco" />
          </picture>
        </div>
        <div className="info_deco-wrapper">
          <picture>
            <source srcSet="img/placeholder.jpg" type="image/webp" />
            <img className="lazy leaf leaf--right" src="img/placeholder.jpg" alt="deco" />
          </picture>
        </div>
      </div>
      ...
      <div className="container">
        <div className="info_content d-flex flex-column align-items-center">
          ...
          <h2 className="info_content-header">
            Our doctors recommend the best Sepil formulation for your wound type and suggest the appropriate dosage and application method to ensure optimal healing and recovery.
          </h2>
        </div>
      </div>
    </section>
